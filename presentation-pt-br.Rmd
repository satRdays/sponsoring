...
Todos podem organizar um satRday, desde que siga estes requisitos: 
...
+ __Os recursos em excesso devem ser utilizados para apoiar a comunidade local__, seja esse o grupo de usuários, retendo os fundos para o seu próximo satRday, ou organizando para que um palestrante de destaque internacional faça um workshop durante o ano seguinte.
...
+ O satRday é "baixo custo": queremos __estabelecer a inscrição pelo menor preço possível__. Isso só é possível devido aos nossos patrocinadores. 
...
+ O satRday é "para todos": a programação está __preparado para atender usuários iniciantes e avançados__.
